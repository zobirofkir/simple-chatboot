        ...
        <div className={`flex min-h-screen ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'}`}>
            ...
            >
                ...
                <button
                    ...
                    className="mt-4 flex w-full transform items-center justify-center gap-2 rounded-xl bg-red-500 px-4 py-3 text-white transition-all duration-200 hover:scale-105 hover:bg-red-600 hover:shadow-xl"
                    style={{
                ...
                >
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path
                            fillRule="evenodd"
                            d="M3 3a1 1 0 0 0-1 1v12a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4a1 1 0 0 0-1-1H3zm11 4a1 1 0 1 0-2 0v4a1 1 0 1 0 2 0V7zm-3 1a1 1 0 1 0-2 0v3a1 1 0 1 0 2 0V8zM8 9a1 1 0 0 0-2 0v1a1 1 0 1 0 2 0V9z"
                            clipRule="evenodd"
                        />
                    </svg>
                    Logout
